...
class CreateJobTests(TestCase):
    ...
    def test_create_job_cost_estimation(self):
        ...
        # OpenAI high quality = $0.134/image, 2 prompts * 2 images = 4
        expected = Decimal('0.536')
...
class CostTrackingAndActualTotalImagesTests(TestCase):
    ...
    def test_estimated_cost_correct_for_mixed_count_job(self):
        ...
        The provider's get_cost_per_image returns 0.034 for medium/1024x1024.
        ...
        # provider.get_cost_per_image('1024x1024', 'medium') = 0.034 (from IMAGE_COST_MAP)
        cost_per_image = Decimal('0.034')
        # Correct (6E-C): sum([3, 1]) = 4 images
        expected_correct = cost_per_image * 4  # Decimal('0.136')
        # Incorrect (pre-6E-C): total_prompts * images_per_prompt = 2 * 1 = 2 images
        expected_wrong = cost_per_image * 2  # Decimal('0.068')
