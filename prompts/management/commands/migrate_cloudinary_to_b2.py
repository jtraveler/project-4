...
USAGE
    ...
    # Avatar / UserProfile migration is NOT supported in this command
    # because the model has no `b2_avatar_url` field. A future spec
    # must add the field + migration before avatars can be moved.
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "images and videos on Prompt. `all` = prompt. "
                "(UserProfile avatars are not supported — see module "
                "docstring.)"
            ),
        )
