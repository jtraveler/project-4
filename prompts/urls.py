...
urlpatterns = [
    ...
    path('api/notifications/<int:notification_id>/click/', notification_views.notification_click, name='notification_click'),
    ...
    path('tools/bulk-ai-generator/api/prepare-prompts/', bulk_generator_views.api_prepare_prompts, name='bulk_generator_prepare_prompts'),
