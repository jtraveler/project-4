"""
prompt_edit_views.py — Prompt edit view.

Split from prompt_views.py in Session 134.
Contains: prompt_edit

Note: prompt_create was removed in Session 135 — the URL name maps to a
RedirectView in urls.py (redirects to upload page). The view function was
