...
class PromptAdmin(SummernoteModelAdmin):
    ...
    fieldsets = (
        ...
        ('AI-Generated Metadata', {
            ...
            'description': (
                ...
                '📊 Scoring weights: descriptors 35%, tags 30%, categories 25%.'
            ),
        }),
        ('Media', {
    ...
    regenerate_ai_content.short_description = (
        '🔄 Regenerate AI content (🚨 overwrites ALL metadata)'
    )
    ...
    def save_related(self, request, form, formsets, change):
        ...
        if cat_count == 0:
            self.message_user(
                ...
                '📊 Related prompts algorithm loses 25% signal.',
                level='warning'
            )
        elif cat_count > 5:
            self.message_user(
        ...
        if desc_count == 0:
            self.message_user(
                ...
                '📊 Descriptors = 35% of related prompts score.',
                level='warning'
            )
        elif desc_count > 10:
            self.message_user(
